...
public class GameLogic : MonoBehaviour {
    ...
    ////////////////////////////////////////////////////////////////New GameModes in v.2.0

    public int BagsLeft = 6; //count of bags
    ...
    void Update()
    {
        ...
        if (gameMode == 3) //using for level 2
        {
            ...
            {
                MusicHolder.GetComponent<AudioSource>().Stop();
                MusicHolder.GetComponent<AudioSource>().clip = BK_Music[3];
                MusicHolder.GetComponent<AudioSource>().Play();
                MusicHolder.GetComponent<Animation>().Play("FadeInMusic"); //see documentation
            ...
            if (NotifyTime < 5) //spawn explore checkpoints
            {
        ...
        if (gameMode == 4) //using for level 2
        {

            Global_Messages.text = "Get 10 fishes quickly!";
            ...
            Points_Text.text = "Fishes: " + FishCount.ToString();
        ...
        if (!gotItem) //if player doesn't hold item eagle will accelerate by pressing mouse button or tap new in v.2.0
        {
